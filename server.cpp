...
// data types of seraizlized data
enum {
    TAG_NIL = 0,    // nil
...
// append serialized data bytes to the back
...
static void handle_read(Conn* conn) {
    ...
    if (conn->outgoing.size() > 0) {
        ...
        // the socket is likely ready to write in a request response protocl,
